...
public void remove_info_page()
{
  cp5.remove("close_info");
  cp5.remove("txt");
}

public void remove_relay(int table_index, String switch_name, String label_name)
{
  if(relay_config.getRowCount() > table_index)
  { 
...
public void close_info(int theValue) 
{
